...
export { CANVAS_HEIGHT, createButton, createCanvas, createCheckbox, createDiv, createParagraph, createNumberInput, createTextInput, createSlider, setBlockVisibility, getStyles };